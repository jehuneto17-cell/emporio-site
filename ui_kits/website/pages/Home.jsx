    ...
    <div>
      ...
      <section className="scheme-3" style={sectionPad}>
        <div style={{ maxWidth: 1280, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
          <div>
            <h1 style={{ marginBottom: 24 }}>O sabor de Minas na sua mesa</h1>
      ...
      <section className="scheme-1" style={sectionPad}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 32 }}>
            <Card style={{ gridColumn: "span 2", display: "grid", gridTemplateColumns: "1fr 1fr" }}>
            ...
            <Card style={{ gridColumn: "span 2", gridRow: "span 2", display: "grid", gridTemplateColumns: "1fr 1fr" }}>
              <div style={{ padding: 24, display: "flex", flexDirection: "column", justifyContent: "center" }}>
      ...
      <section className="scheme-3" style={sectionPad}>
        <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", flexDirection: "column", alignItems: "center" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 48, width: "100%" }}>
            {[
...
function NewsletterForm() {
  ...
  return (
    <div style={{ maxWidth: 380 }}>
      <form onSubmit={(e) => { e.preventDefault(); setSent(true); }} style={{ display: "flex", gap: 12, marginBottom: 16 }}>
        <Input type="email" placeholder="Seu melhor e-mail" required />
        <Button size="sm">{sent ? "Enviado!" : "Baixar"}</Button>
      </form>
